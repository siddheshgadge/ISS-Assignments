...
select * from employee where dept_name = ( select dept_name from department where dept_hod = 'surya');
...
create table employee_comps like employee;
insert into employee_comps select * from employee where dept_name = 'comps';
select * from employee_comps;

create table employee_it like employee;
insert into employee_it select * from employee where dept_name = 'it';
select * from employee_it;

create table employee_extc like employee;
insert into employee_extc select * from employee where dept_name = 'extc';
select * from employee_extc;

create table employeeBackup as select * from employee;
